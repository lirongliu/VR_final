...
public class BossSceneController : SceneController {
	...
	public BossSceneController (): base() {
		...
		instructionList [cbId][0] = "Task 2:You and your partner are controlling the same character! Stare at the boss for 10 seconds and to pass this puzzle.";
		
		instructionList [tbId] = new string[1];
		instructionList [tbId][0] = "Task 2:You and your partner are controlling the same character. Control the movement of the character to avoid the enemies!";
